...
GLTFLoader =  function (THREE) {
	...
	// Compatibility shim for newer THREE versions where Loader.Handlers was removed.
	if (!THREE.Loader) {
	...
	// Polyfill for deprecated BufferGeometry.addAttribute in newer THREE versions.

	// Polyfill for deprecated Object3D.applyMatrix in newer THREE versions.
	if (THREE.Object3D && !THREE.Object3D.prototype.applyMatrix) {
		THREE.Object3D.prototype.applyMatrix = function (matrix) {
			if (this.applyMatrix4) {
